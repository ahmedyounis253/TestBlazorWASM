    ...
    public partial class fixing : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<string>(
                ...
                oldNullable: true,
                oldComputedColumnSql: "Upper(Concat(SubString([Role],1,1) + SubString([Name],1,1),Round([Age]*Round(RAND()*1000,0)/(RAND()*10))))");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<string>(
                ...
                type: "nvarchar(max)",
                nullable: true,
                computedColumnSql: "Upper(Concat(SubString([Role],1,1) + SubString([Name],1,1),Round([Age]*Round(RAND()*1000,0)/(RAND()*10))))",
                oldClrType: typeof(string),
                oldType: "nvarchar(max)",
                oldNullable: true,
