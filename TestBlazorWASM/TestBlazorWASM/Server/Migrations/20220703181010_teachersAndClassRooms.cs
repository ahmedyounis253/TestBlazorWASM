...
{
    public partial class teachersAndClassRooms : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassRoomsStudents", x => new { x.ClassRoomId, x.StudentId });
                    table.ForeignKey(
                        name: "Fk-ClassRoom-ClassRoom-Student",
